...
export const SIGNATURE_FRAMEWORKS = [
  {
    ...
    label: "Flagship Concept",
    short:
      "A conceptual journey that begins with purpose and moves toward value creation, strategy, and meaningful outcomes.",
    description:
  ...
  },
  {
    ...
    short:
      "A signature framework centered on adaptability, value creation, and intelligent alignment across marketing and business decisions.",
    description:
  ...
  },
  {
    ...
    label: "Signature Framework",
    short:
      "A diagnostic strategic model designed to identify value drift and strengthen relevance, decision quality, and market alignment.",
    description:
      "This learning area focuses on a diagnostic strategic model designed to identify value drift and strengthen relevance, decision quality, and market alignment. It is especially relevant for those who want to understand why businesses, offerings, or strategies lose effectiveness over time, and how that drift can be recognized and addressed. It may appeal to professionals, managers, educators, and advanced learners interested in sharper evaluation and stronger strategic judgment.",
  },
];
    ...
    courses: [
      {
        ...
        short:
          "Marketing as a driver of long-term direction, competitive advantage, and sustainable growth — not promotion alone.",
        description:
      ...
      },
      {
        ...
        short:
          "Digital tools and channels explored through a marketing lens — visibility, engagement, and business goals.",
        description:
      ...
      },
      {
        ...
        title: "Branding",
        short:
          "The disciplined shaping of value, meaning, trust, and differentiation over time.",
        description:
      ...
      },
      {
        ...
        short:
          "Strategic use of social platforms for awareness, engagement, community, and growth.",
        description:
      ...
      },
      {
        ...
        short:
          "Market intelligence and consumer understanding that reduce uncertainty and improve relevance.",
        description:
      ...
      },
      {
        ...
        short:
          "How promotional tools and communication influence awareness, persuasion, and action within a strategic system.",
        description:
      ...
      },
      {
        ...
        short:
          "Pricing as a strategic expression of value, positioning, competitiveness, and profitability.",
        description:
      ...
      },
      {
        ...
        short:
          "A broader understanding of planning, organizational direction, and strategic management.",
        description:
          "This learning area develops a broader understanding of business planning, organizational direction, and strategic management. It is suitable for visitors who want to strengthen overall business thinking and connect marketing decisions to wider business realities. Learners exploring this area should expect an integrated perspective that supports more coherent and purposeful decision making.",
      },
    ],
  },
  {
    ...
    courses: [
      {
        ...
        short:
          "Relationship-based selling where trust, value, and relevance matter deeply.",
        description:
      ...
      },
      {
        ...
        short:
          "Digital platforms and online interactions as engines of trust, prospecting, and sales effectiveness.",
        description:
      ...
      },
      {
        ...
        short:
          "Sales systems and customer relationships that drive retention, loyalty, and sustainable performance.",
        description:
      ...
      },
      {
        ...
        short:
          "Entrepreneurial thinking and the realities of developing smaller ventures and initiatives.",
        description:
          "This learning area focuses on practical growth, entrepreneurial thinking, and the realities of developing smaller ventures and business initiatives. It is suitable for aspiring entrepreneurs, SME owners, and learners interested in turning ideas into viable ventures. Visitors should expect attention to value creation, adaptability, and purposeful growth rather than only startup enthusiasm.",
      },
    ],
  },
  {
    ...
    courses: [
      {
        ...
        short:
          "Generating, shaping, and refining ideas in ways that are strategically relevant and value-creating.",
        description:
      ...
      },
      {
        ...
        short:
          "Evaluating ideas before significant time, effort, and resources are committed.",
        description:
      ...
      },
      {
        ...
        short:
          "Transforming ideas into meaningful market offerings through alignment, insight, and value creation.",
        description:
      ...
      },
      {
        ...
        short:
          "Rethinking and redefining value to create stronger, more relevant offerings.",
        description:
          "This learning area explores how organizations can rethink and redefine value in order to create stronger, more relevant offerings. It is suitable for learners interested in strategy, differentiation, and deeper value creation logic. Visitors should expect conceptual depth and a more advanced perspective on how value can be expanded or repositioned.",
      },
    ],
  },
  {
    id: "analytical-decision",
    letter: "E",
    ...
    courses: [
      {
        ...
        short:
          "Evaluating possible business situations to support more informed strategic choices.",
        description:
      ...
      },
      {
        ...
        short:
          "Applied learning through realistic decision environments that sharpen judgment and strategy.",
        description:
          "This learning area provides applied learning through realistic decision environments that strengthen analysis, judgment, and strategic thinking. It is suitable for those who learn well through scenarios, experimentation, and consequence based decision making. Visitors should expect a more immersive and practice oriented experience than a purely theoretical topic.",
      },
    ],
  },
  {
    ...
    courses: [
      {
        ...
        short:
          "AI as a strategic enabler in teaching, learning, decision making, and market effectiveness.",
        description:
      ...
      },
      {
        ...
        short:
          "Practical capabilities that support professional growth, confidence, and meaningful contribution.",
        description:
      ...
      },
      {
        ...
        short:
          "Structured offerings aimed at academic advancement and executive-level development.",
        description:
          "This learning area is designed for more structured learning opportunities aimed at academic advancement and executive level development. It is suitable for those seeking a more serious, growth oriented, and professionally relevant learning experience. Visitors should expect offerings that balance conceptual depth with practical significance.",
      },
    ],
  },
];